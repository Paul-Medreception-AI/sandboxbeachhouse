...
export const metadata: Metadata = {
  title: "Holiday Stays in Holmes Beach | Sandbox Beach House",
  description:
    "Plan holiday weekends and weeklong stays on Anna Maria Island. Browse holiday travel guides with open dates for Sandbox Beach House in Holmes Beach.",
};
    ...
    <main className="bg-gradient-to-b from-sky-50 via-white to-white text-slate-900">
      <section className="relative overflow-hidden border-b border-sky-100 bg-gradient-to-br from-sky-50 via-white to-amber-50">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <p className="mt-6 text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Holiday travel on Anna Maria Island</p>
          <h1 className="mt-4 text-4xl font-bold text-slate-900 md:text-5xl">Holiday and Long-Weekend Guides</h1>
          <p className="mt-6 max-w-3xl text-lg text-slate-700">
            Plan your holiday escape in Holmes Beach with guides that match your dates. Each page points you to open dates and a
            relaxed rhythm for beach days, pool resets, and easy island dining.
          </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-4 md:grid-cols-2">
            {holidayPages.map((page, index) => {
              const accent = ACCENTS[index % ACCENTS.length];
              return (
                <Link
                  key={page.slug}
                  href={`/holidays/${page.slug}/`}
          ...
          <section className="mt-12 rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 to-sky-900 p-8 text-white shadow-sm">
            <h2 className="text-2xl font-bold">Planning a holiday stay?</h2>
            <p className="mt-3 max-w-2xl text-white/85">
              Choose a holiday guide, then match it to open dates for a low-stress beach trip. Private pool, walk-to-beach
              access, and a calm Holmes Beach base.
            </p>
