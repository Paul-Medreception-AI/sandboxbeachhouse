...
import { getHolidayPage, holidayPages } from "./data";
...
export function getHolidayMetadata(slug: string): Metadata {
  const page = getHolidayPage(slug);
  if (!page) return {};
  return {
    title: page.title,
...
export function getHolidaySlugs() {
  return holidayPages.map((page) => page.slug);
}

export default function HolidayTopic({ slug }: { slug: string }) {
  const page = getHolidayPage(slug);
        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          <nav className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500" aria-label="Breadcrumb">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Link href="/holidays/" className="hover:text-slate-700">
                Holidays
              </Link>
              <span className="text-slate-300">/</span>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-10">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="text-2xl font-semibold text-slate-900">Sample holiday rhythm</h2>
